class ContentsController < ApplicationController
  ...
  def destroy
    ...
    if @permissions >= 20
      ...
      respond_to do |format|
        format.html do
          redirect_to contents_url, notice: 'Borraste un contenido. Bien hecho... no era digno de TransmediAcademy.'
        end
  ...
  def content_params
    params.require(:content).permit(:course_id, :chapter_id, :name, :sequence, :typeOfContent, :richContent,
                                    :priority, :testId, :requirements, :minimumScore, :goals, :embed)
  end
