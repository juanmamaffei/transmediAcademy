...
class UserContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_content" do
    assert_difference('UserContent.count') do
      post user_contents_url, params: { user_content: { claps: @user_content.claps, content_id: @user_content.content_id, markdownContent: @user_content.markdownContent, responseTo: @user_content.responseTo, sticked: @user_content.sticked, type: @user_content.type, user_id: @user_content.user_id } }
    end
  ...
  test "should update user_content" do
    patch user_content_url(@user_content), params: { user_content: { claps: @user_content.claps, content_id: @user_content.content_id, markdownContent: @user_content.markdownContent, responseTo: @user_content.responseTo, sticked: @user_content.sticked, type: @user_content.type, user_id: @user_content.user_id } }
