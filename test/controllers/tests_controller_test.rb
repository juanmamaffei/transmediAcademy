...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create test' do
    assert_difference('Test.count') do
      post tests_url,
           params: { test: { a1: @test.a1, a2: @test.a2, a3: @test.a3, a4: @test.a4, content_id: @test.content_id,
                             correct: @test.correct, difficulty: @test.difficulty, question: @test.question, score: @test.score, state: @test.state } }
    end
