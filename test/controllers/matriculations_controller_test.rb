...
class MatriculationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create matriculation" do
    assert_difference('Matriculation.count') do
      post matriculations_url, params: { matriculation: { course_id: @matriculation.course_id, permissions: @matriculation.permissions, user_id: @matriculation.user_id } }
    end
  ...
  test "should update matriculation" do
    patch matriculation_url(@matriculation), params: { matriculation: { course_id: @matriculation.course_id, permissions: @matriculation.permissions, user_id: @matriculation.user_id } }
